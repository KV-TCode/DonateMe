...
local Interface = {} do
	Interface.Folder = "FluentSettings"
	Interface.Settings = {
		Acrylic = true,
		Transparency = true,
		MenuKeybind = "M",
	...
	function Interface:SetFolder(folder)
		self.Folder = folder
		self:BuildFolderTree()
	end

	function Interface:SetLibrary(library)
		self.Library = library
	end

	function Interface:BuildFolderTree()
		local paths = {}
	...
	function Interface:SaveSettings()
		writefile(self.Folder .. "/options.json", game:GetService("HttpService"):JSONEncode(self.Settings))
	end
	...
	function Interface:LoadSettings()
		...
		if isfile(path) then
			...
			if success and typeof(decoded) == "table" then
				...
				warn("[Interface] Failed to load or decode JSON from " .. path)
			end
		end
	end	

	function Interface:BuildInterfaceSection(tab)
